...
describe('linked-list.js', () => {
  ...
  test('find should return null if this.next is null', () => {
  ...
  test('find should identify correct value', () => {
    let first = new LinkedList(3);
    let second = new LinkedList(5);
    let third = new LinkedList(7);

    first.append(second);
    first.append(third);

    expect(first.value).toEqual(3);
    expect(first.next.value).toEqual(5);
    expect(first.next.next.value).toEqual(7);
